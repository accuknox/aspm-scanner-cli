...
```bash
pip install https://github.com/accuknox/aspm-scanner-cli/releases/download/v0.13.6/accuknox_aspm_scanner-0.13.6-py3-none-any.whl
````
...
```bash
ASPM_DEBUG=TRUE accuknox-aspm-scanner scan iac --command "-d ."
```
