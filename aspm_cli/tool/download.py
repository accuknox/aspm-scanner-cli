...
class ToolDownloader:
    TOOL_URLS = {
        ...
        "Linux": {
            ...
            "codeassure": "https://github.com/accuknox/aspm-scanner-cli/releases/download/v0.14.9/codeassure.tar.gz",
            "gitleaks": "https://github.com/accuknox/aspm-scanner-cli/releases/download/v0.14.9/gitleaks.tar.gz",
        },
    }
