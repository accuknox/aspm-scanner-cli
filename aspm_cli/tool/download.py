...
class ToolDownloader:
    TOOL_URLS = {
        ...
        "Linux": {
            ...
            "codeassure": "https://github.com/accuknox/aspm-scanner-cli/releases/download/v0.15.1/codeassure.tar.gz",
            "gitleaks": "https://github.com/accuknox/aspm-scanner-cli/releases/download/v0.15.1/gitleaks.tar.gz",
        },
    }
